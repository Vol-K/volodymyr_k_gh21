...
def added_processing(request, prod_id, prod_category):
    ...
    return product.quantity, user_cart.get("item_quantity")


# Checking & returning quantity of products inside user cart.
...
# Getting detailed info about products inside user cart.
